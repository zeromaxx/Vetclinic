   <div class="row w-75 m-auto d-block d-md-flex align-items-center p-3 top-nav">
       <div class="col-md-3">
           <a href="{{ route('home') }}"><span class="d-inline-block fs-4">Fluffy</span><span style="color: black;" class="fw-bold fs-3 ms-2">Paw</span>
           </a>
       </div>
       <div class="col-md-3">
       ...
       <div class="container-fluid w-75">
           ...
           <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
               <div class="navbar-nav w-100">
                   ...
                   <a class="{{ request()->is('add_pet') ? 'active-link nav-link fs-6' : 'nav-link fs-6' }}" href="{{ route('add_pet') }}">Προσθήκη Κατοικιδίου</a>
                   ...
                   <a class="{{ request()->is('appointments') ? 'active-link nav-link fs-6' : 'nav-link fs-6' }}" href="{{ route('appointments') }}">Ραντεβού</a>
                   <a class="{{ request()->is('users') ? 'active-link nav-link fs-6' : 'nav-link fs-6' }}" href="{{ route('users') }}">Χρήστες</a>
