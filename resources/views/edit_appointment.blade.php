        ...
        <form action="{{ route('update_appointment', $appointment['id']) }}" method="POST" class="border-0 w-50">
            ...
            <div class="row justify-content-center ">
                <div class="col-8">
                    ...
                    <input value="{{ $appointment['schedule_date'] }}" required type="text" class="form-control mb-3" name="schedule_date">
                    <label for="time" class="form-label">Ώρα</label>
                    <input value="{{ $appointment['time'] }}" required type="text" class="form-control mb-3" name="time">
                </div>
            </div>
